...
export default function About() {
  return (
    ...
    >
        <h2 style={{ fontWeight: '800', fontSize: '36px' }}>
        About Coffee Map
        </h2>

      <p style={{ maxWidth: '700px' }}>
        Coffee Map is an interactive visualization tool that helps users make educated purchasing decisions. A lot of research goes into making a good cup of coffee, from knowing which countries
 ...
 Through Coffee Map, you will be able to interact 
                 ...
                 currently in their harvesting season will be displayed based on the date.
      </p>
